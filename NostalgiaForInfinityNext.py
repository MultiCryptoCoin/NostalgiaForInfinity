...
class NostalgiaForInfinityNext(IStrategy):
    ...
    buy_min_inc_11 = DecimalParameter(
        0.005, 0.05, default=0.02, space="buy", decimals=3, optimize=False, load=True
    )
    ...
    buy_rsi_11 = DecimalParameter(
        34.0, 50.0, default=44.0, space="buy", decimals=1, optimize=False, load=True
    )
    ...
    buy_ma_offset_12 = DecimalParameter(
        0.93, 0.97, default=0.907, space="buy", decimals=3, optimize=False, load=True
    )
    buy_rsi_12 = DecimalParameter(
        26.0, 40.0, default=34.0, space="buy", decimals=1, optimize=False, load=True
    )
    ...
    buy_cti_13 = DecimalParameter(
        -0.99, -0.5, default=-0.74, space="buy", decimals=2, optimize=False, load=True
    )
    buy_ewo_13 = DecimalParameter(
        -14.0, -7.0, default=-9.6, space="buy", decimals=1, optimize=False, load=True
    )
    ...
    buy_ewo_17 = DecimalParameter(
        -18.0, -10.0, default=-12.4, space="buy", decimals=1, optimize=False, load=True
    )
    ...
    buy_rsi_18 = DecimalParameter(
        16.0, 32.0, default=30.0, space="buy", decimals=1, optimize=False, load=True
    )
    buy_bb_offset_18 = DecimalParameter(
        0.98, 1.0, default=0.985, space="buy", decimals=3, optimize=False, load=True
    )
    ...
    buy_25_cti = DecimalParameter(
        -0.99, -0.4, default=-0.6, space="buy", decimals=2, optimize=False, load=True
    )
    ...
    buy_28_ma_offset = DecimalParameter(
        0.90, 0.99, default=0.92, space="buy", optimize=False, load=True
    )
    buy_28_ewo = DecimalParameter(
        2.0, 14.0, default=12.4, space="buy", decimals=1, optimize=False, load=True
    )
    buy_28_rsi = DecimalParameter(
        24.0, 44.0, default=38.0, space="buy", decimals=1, optimize=False, load=True
    )
    ...
    buy_29_ma_offset = DecimalParameter(
        0.90, 0.99, default=0.91, space="buy", optimize=False, load=True
    )
    ...
    buy_30_ewo = DecimalParameter(
        2.0, 14.0, default=7.8, space="buy", decimals=1, optimize=False, load=True
    )
    ...
    buy_33_ma_offset = DecimalParameter(
        0.90, 0.99, default=0.974, space="buy", optimize=False, load=True
    )
    ...
    buy_33_ewo = DecimalParameter(
        2.0, 14.0, default=9.0, space="buy", decimals=1, optimize=False, load=True
    )
    ...
    buy_34_ma_offset = DecimalParameter(
        0.90, 0.99, default=0.968, space="buy", optimize=False, load=True
    )
    buy_34_dip = DecimalParameter(
        0.001, 0.02, default=0.002, space="buy", decimals=3, optimize=False, load=True
    )
