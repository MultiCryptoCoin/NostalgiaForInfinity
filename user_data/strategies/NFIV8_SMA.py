...
class NFIV8_SMA(IStrategy):
    ...
    buy_min_inc_1 = DecimalParameter(
        0.01, 0.05, default=0.021, space="buy", decimals=3, optimize=False, load=True
    )
    ...
    buy_rsi_1 = DecimalParameter(
        20.0, 40.0, default=35.4, space="buy", decimals=1, optimize=False, load=True
    )
    buy_mfi_1 = DecimalParameter(
        20.0, 40.0, default=50.0, space="buy", decimals=1, optimize=False, load=True
    )
    buy_cti_1 = DecimalParameter(
        -0.99, -0.5, default=-0.87, space="buy", decimals=2, optimize=False, load=True
    )
    ...
    buy_cti_4 = DecimalParameter(
        -0.99, -0.5, default=-0.68, space="buy", decimals=2, optimize=False, load=True
    )
    ...
    buy_ma_offset_15 = DecimalParameter(
        0.93, 0.99, default=0.96, space="buy", decimals=3, optimize=False, load=True
    )
    ...
    buy_chop_max_19 = DecimalParameter(
        20.0, 60.0, default=23.0, space="buy", decimals=1, optimize=False, load=True
    )
    ...
    buy_27_wr_max = DecimalParameter(
        95, 99, default=99.0, space="buy", decimals=1, optimize=False, load=True
    )
    ...
    buy_28_ewo = DecimalParameter(
        2.0, 14.0, default=12.2, space="buy", decimals=1, optimize=False, load=True
    )
    buy_28_rsi = DecimalParameter(
        24.0, 44.0, default=40.0, space="buy", decimals=1, optimize=False, load=True
    )
    buy_28_cti = DecimalParameter(
        -0.99, -0.4, default=-0.84, space="buy", decimals=2, optimize=False, load=True
    )
    ...
    buy_30_rsi = DecimalParameter(
        24.0, 48.0, default=42.0, space="buy", decimals=1, optimize=False, load=True
    )
    ...
    buy_32_ma_offset = DecimalParameter(
        0.90, 0.99, default=0.946, space="buy", optimize=False, load=True
    )
    ...
    buy_33_ewo = DecimalParameter(
        2.0, 14.0, default=7.6, space="buy", decimals=1, optimize=False, load=True
    )
    ...
    buy_34_ewo = DecimalParameter(
        -24.0, -8.0, default=-20.0, space="buy", decimals=1, optimize=False, load=True
    )
    buy_34_cti = DecimalParameter(
        -0.99, -0.4, default=-0.88, space="buy", decimals=2, optimize=False, load=True
    )
    buy_34_volume = DecimalParameter(
        0.6, 6.0, default=1.1, space="buy", decimals=1, optimize=False, load=True
    )
    ...
    sell_custom_rsi_4 = DecimalParameter(
        35.0, 50.0, default=38.0, space="sell", decimals=2, optimize=False, load=True
    )
    ...
    sell_custom_rsi_5 = DecimalParameter(
        35.0, 50.0, default=39.0, space="sell", decimals=2, optimize=False, load=True
    )
    ...
    sell_custom_rsi_6 = DecimalParameter(
        38.0, 55.0, default=46.0, space="sell", decimals=2, optimize=False, load=True
    )
    ...
    sell_custom_under_rsi_3 = DecimalParameter(
        50.0, 68.0, default=50.0, space="sell", decimals=1, optimize=False, load=True
    )
    ...
    sell_custom_under_rsi_4 = DecimalParameter(
        50.0, 68.0, default=42.0, space="sell", decimals=1, optimize=False, load=True
    )
    ...
    sell_custom_under_rsi_5 = DecimalParameter(
        46.0, 62.0, default=42.0, space="sell", decimals=1, optimize=False, load=True
    )
    ...
    sell_custom_under_rsi_6 = DecimalParameter(
        44.0, 60.0, default=40.0, space="sell", decimals=1, optimize=False, load=True
    )
    ...
    sell_custom_under_rsi_7 = DecimalParameter(
        46.0, 60.0, default=39.0, space="sell", decimals=1, optimize=False, load=True
    )
    ...
    sell_custom_under_rsi_8 = DecimalParameter(
        40.0, 58.0, default=38.0, space="sell", decimals=1, optimize=False, load=True
    )
    ...
    sell_custom_pump_rsi_2_2 = DecimalParameter(
        36.0, 50.0, default=36.0, space="sell", decimals=1, optimize=False, load=True
    )
    sell_custom_pump_profit_2_3 = DecimalParameter(
        0.02, 0.10, default=0.04, space="sell", decimals=3, optimize=False, load=True
    )
    sell_custom_pump_rsi_2_3 = DecimalParameter(
        38.0, 50.0, default=38.0, space="sell", decimals=1, optimize=False, load=True
    )
    ...
    sell_custom_pump_rsi_3_2 = DecimalParameter(
        34.0, 50.0, default=36.0, space="sell", decimals=1, optimize=False, load=True
    )
    ...
    def sell_over_main(self, current_profit: float, last_candle) -> tuple:
        if last_candle["close"] > last_candle["ema_200"]:
            if current_profit >= self.sell_custom_profit_11.value:
                ...
                if (last_candle["rsi_14"] < self.sell_custom_rsi_7.value) and (
                    last_candle["cmf"] < 0.0
                ):
                ...
                if (last_candle["rsi_14"] < self.sell_custom_rsi_6.value) and (
                    last_candle["cmf"] < 0.0
                ):
                ...
                if (last_candle["rsi_14"] < self.sell_custom_rsi_5.value) and (
                    last_candle["cmf"] < 0.0
                ):
                ...
                if (last_candle["rsi_14"] < self.sell_custom_rsi_4.value) and (
                    last_candle["cmf"] < 0.0
                ):
                ...
                if (last_candle["rsi_14"] < self.sell_custom_rsi_3.value) and (
                    last_candle["cmf"] < 0.0
                ):
                ...
                if (last_candle["rsi_14"] < self.sell_custom_rsi_2.value) and (
                    last_candle["cmf"] < 0.0
                ):
                ...
                if (last_candle["rsi_14"] < self.sell_custom_rsi_1.value) and (
                    last_candle["cmf"] < 0.0
                ):
                ...
                if (last_candle["rsi_14"] < self.sell_custom_rsi_0.value) and (
                    last_candle["cmf"] < 0.0
                ):
    ...
    def sell_under_main(self, current_profit: float, last_candle) -> tuple:
        if last_candle["close"] < last_candle["ema_200"]:
            if current_profit >= self.sell_custom_under_profit_11.value:
                ...
                if (last_candle["rsi_14"] < self.sell_custom_under_rsi_0.value) and (
                    last_candle["cmf"] < 0.0
                ):
    ...
    def normal_tf_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe["crsi"] = (
            dataframe["rsi_5"] + dataframe["srsi"] + dataframe["roc"]
        ) / 3
