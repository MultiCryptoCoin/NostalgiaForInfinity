...
class NostalgiaForInfinityV4(IStrategy):
    ...
    buy_ewo_13 = DecimalParameter(
        -14.0, -7.0, default=-7.9, space="buy", decimals=1, optimize=False, load=True
    )
    ...
    def populate_buy_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        conditions.append(
            (
                ...
                & (
                    dataframe["close"]
                    > (dataframe["ema_200_1h"] * self.buy_ema_rel_8.value)
                )
                & (dataframe["ema_50_1h"] > dataframe["ema_100_1h"])
        ...
        conditions.append(
            (
                ...
                & (
                    dataframe["close"]
                    < dataframe["sma_30"] * self.buy_ma_offset_9.value
                )
                & (
                    dataframe["close"]
        ...
        conditions.append(
            (
                ...
                & (
                    dataframe["close"]
                    < dataframe["sma_30"] * self.buy_ma_offset_14.value
                )
                & (dataframe["volume"] > 0)
            )
        )
        ...
        conditions.append(
            (
                ...
                & (
                    dataframe["close"]
                    < dataframe["sma_30"] * self.buy_ma_offset_15.value
                )
                & (dataframe["volume"] > 0)
            )
        )
