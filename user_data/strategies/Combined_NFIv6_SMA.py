...
class Combined_NFIv6_SMA(IStrategy):
    ...
    buy_dip_threshold_8 = DecimalParameter(
        0.2, 0.5, default=0.42, space="buy", decimals=3, optimize=False, load=True
    )
    # Loose dips
    ...
    buy_dip_threshold_12 = DecimalParameter(
        0.2, 0.5, default=0.8, space="buy", decimals=3, optimize=False, load=True
    )
    ...
    buy_ema_open_mult_6 = DecimalParameter(
        0.02, 0.03, default=0.024, space="buy", decimals=3, optimize=False, load=True
    )
    ...
    buy_rsi_8 = DecimalParameter(
        16.0, 30.0, default=20.0, space="buy", decimals=1, optimize=False, load=True
    )
    ...
    buy_bb_offset_9 = DecimalParameter(
        0.96, 0.98, default=0.965, space="buy", decimals=3, optimize=False, load=True
    )
    ...
    buy_ewo_13 = DecimalParameter(
        -14.0, -7.0, default=-11.8, space="buy", decimals=1, optimize=False, load=True
    )
    ...
    sell_custom_rsi_1 = DecimalParameter(
        30.0, 50.0, default=34.0, space="sell", decimals=2, optimize=False, load=True
    )
    ...
    sell_custom_rsi_5 = DecimalParameter(
        35.0, 50.0, default=44.0, space="sell", decimals=2, optimize=False, load=True
    )
    ...
    sell_custom_rsi_6 = DecimalParameter(
        38.0, 55.0, default=49.0, space="sell", decimals=2, optimize=False, load=True
    )
    ...
    sell_custom_rsi_8 = DecimalParameter(
        40.0, 50.0, default=54.0, space="sell", decimals=2, optimize=False, load=True
    )
    ...
    sell_custom_under_rsi_0 = DecimalParameter(
        28.0, 40.0, default=33.0, space="sell", decimals=1, optimize=False, load=True
    )
    ...
    sell_custom_under_rsi_8 = DecimalParameter(
        40.0, 58.0, default=50.0, space="sell", decimals=1, optimize=False, load=True
    )
    ...
    sell_custom_under_rsi_9 = DecimalParameter(
        32.0, 48.0, default=44.0, space="sell", decimals=1, optimize=False, load=True
    )
    ...
    sell_pump_threshold_9 = DecimalParameter(
        0.2, 0.5, default=0.3, space="sell", decimals=2, optimize=False, load=True
    )
