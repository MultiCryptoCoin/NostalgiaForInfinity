...
class CombinedBinClucMadBigZV03Develop(IStrategy):
    INTERFACE_VERSION = 2
    ...
    sell_condition_0_enable = CategoricalParameter(
        [True, False], default=True, space="sell", optimize=False, load=True
    )
    ...
    def custom_stoploss(
        ...
        **kwargs,
        ...
        if current_profit > 0:
            ...
            trade_time_50 = current_time - timedelta(minutes=240)
    ...
    def populate_buy_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[
            (
                ...
                & (
                    dataframe["volume"]
                    < (
                        dataframe["volume_mean_slow_30"].shift(1)
        ...
        dataframe.loc[
            (
                ...
                & (
                    (
                        dataframe["volume"]
                        < (dataframe["volume_mean_slow_30"].shift(1) * 21)
                    )
                    | (
                        dataframe["volume_mean_slow_30"]
                        > (dataframe["volume_mean_slow_30"].shift(30) * 0.4)
                    )
                )
        ...
        dataframe.loc[
            (
                ...
                & (
                    (
                        dataframe["volume"]
                        < (dataframe["volume_mean_slow_30"].shift(1) * 20)
                    )
                    | (
                        dataframe["volume_mean_slow_30"]
                        > dataframe["volume_mean_slow_30"].shift(30) * 0.4
        ...
        dataframe.loc[
            (
                ...
                & (dataframe["rsi_1h"] < 71)
                & (
                    dataframe["volume_mean_slow_48"]
                    > dataframe["volume_mean_slow_48"].shift(48)
                    * self.bzv7_buy_volume_pump_1.value
                )
                & (
                    dataframe["volume_mean_slow_48"] * self.bzv7_buy_volume_pump_1.value
                    < dataframe["volume_mean_slow_48"].shift(48)
                )
        ...
        dataframe.loc[
            (
                ...
                & (
                    ...
                    * self.bzv7_buy_bb20_close_bblowerband_safe_1.value
                )
                & (dataframe["rsi_1h"] < 69)
        ...
        dataframe.loc[
            (
                ...
                & (
                    dataframe["close"]
                    < dataframe["bb_lowerband"]
                    * self.bzv7_buy_bb20_close_bblowerband_safe_2.value
                )
                & (
                    dataframe["volume_mean_slow_48"]
                    > dataframe["volume_mean_slow_48"].shift(48)
