...
class NostalgiaForInfinityV2(IStrategy):
    ...
    buy_bb40_bbdelta_close = DecimalParameter(
        0.005, 0.05, default=0.049, space="buy", optimize=True, load=True
    )
    ...
    buy_bb40_tail_bbdelta = DecimalParameter(
        0.15, 0.45, default=0.287, space="buy", optimize=True, load=True
    )
    buy_bb20_close_bblowerband = DecimalParameter(
        0.8, 1.1, default=0.991, space="buy", optimize=True, load=True
    )
    buy_bb20_volume = IntParameter(
        18, 34, default=20, space="buy", optimize=True, load=True
    )
    buy_rsi_diff = DecimalParameter(
        36.0, 54.0, default=37.0, space="buy", optimize=True, load=True
    )

    sell_rsi_bb = DecimalParameter(
        60.0, 80.0, default=70, space="sell", optimize=True, load=True
    )
    sell_rsi_main = DecimalParameter(
        72.0, 90.0, default=78.0, space="sell", optimize=True, load=True
    )
    sell_rsi_2 = DecimalParameter(
        72.0, 90.0, default=60.0, space="sell", optimize=True, load=True
    )
    sell_ema_relative = DecimalParameter(
        0.005, 0.1, default=0.03, space="sell", optimize=False, load=True
    )
    sell_rsi_diff = DecimalParameter(
        0.0, 5.0, default=5.0, space="sell", optimize=True, load=True
    )
