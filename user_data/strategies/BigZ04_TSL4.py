...
class BigZ04_TSL4(IStrategy):
    ...
    buy_rsi_1h_0 = DecimalParameter(
        55.0, 85.0, default=71.0, space="buy", decimals=1, optimize=False, load=True
    )
    buy_rsi_1h_1a = DecimalParameter(
        65.0, 78.0, default=69.0, space="buy", decimals=1, optimize=False, load=True
    )
    ...
    buy_rsi_0 = DecimalParameter(
        10.0, 40.0, default=30.0, space="buy", decimals=1, optimize=False, load=True
    )
    ...
    buy_dip_0 = DecimalParameter(
        1.015, 1.040, default=1.024, space="buy", decimals=3, optimize=False, load=True
    )
