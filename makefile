...
dry: # run dry mode
	docker-compose run --rm freqtrade \
		trade --config user_data/data/pairlists.json --config user_data/data/$(EXCHANGE)-usdt-static.json --verbose


webserver: # run webserver mode
	docker-compose run --rm freqtrade \
		webserver --config user_data/data/pairlists.json --config user_data/data/$(EXCHANGE)-usdt-static.json --verbose
